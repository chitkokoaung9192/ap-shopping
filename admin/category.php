        ...
        <div class="row">
          <div class="col-md-12">
            ...
            ?>
              ...
              <div class="card-body">
                <div>
                  <a type="button" class="btn btn-success" href="cat_add.php">New Category</a>
                </div><br>
                <table class="table table-bordered">
                  ...
                  <?php
                    ...
                    <tr>
                      <td><?php echo $i;?></td>
                      <td><?php echo escape(substr($value['name'],0,30)) ?></td>
                      <td><?php echo escape(substr($value['description'],0,85)) ?></td>
                        <td>
                          <div class="btn-group">
                            <div class="container">
                              <a type="button" class="btn btn-warning" href="cat_edit.php?id=<?php echo $value['id'] ?>">Edit</a>
                            </div>
                            <div class="container">
                              <a type="button" class="btn btn-danger" href="cat_delete.php?id=<?php echo $value['id'] ?>"
