        ...
        <div class="row">
          <div class="col-md-12">
            ...
            if (empty($_POST['search']) && empty($_COOKIE['search'])) {
              ...
              <div class="card-body">
                <div>
                  <a type="button" class="btn btn-success" href="product_add.php">Create New Products</a>
                </div><br>
                    ...
                    <tr>
                      ...
                      <td><?php echo escape($value['price']) ?></td>
                        <td>
                          <div class="btn-group">
                            <div class="container">
                              <a type="button" class="btn btn-warning" href="product_edit.php?id=<?php echo escape($value['id']) ?>">Edit</a>
                            </div>
                            <div class="container">
                              <a type="button" class="btn btn-danger" href="product_delete.php?id=<?php echo escape($value['id']) ?>"
