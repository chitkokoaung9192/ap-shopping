<?php
	...
	if ($_POST) {
		...
		|| empty($_POST['address']) || strlen($_POST['email']) < 4 ) {
			if (empty($_POST['name'])) {
			...
			if (strlen($_POST['password']) < 4 ) {
				$passwordError = 'Password shoulb be 4 char at least';
			}
		}else {
			$name =$_POST['name'];
			$email =$_POST['email'];
			...
			if ($user) {
				...
				$stmts =$pdo->prepare("INSERT INTO users(name,email,password,phone,address) VALUES (:name,:email,:password,:phone,:address)");
...
<body>
	...
	<section class="login_box_area section_gap">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="login_form_inner" style="padding-top: 85px;">
